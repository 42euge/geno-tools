---
title: geno-ws-init
description: Create development workspaces from GitHub issues, JIRA tickets, repo names, or feature ideas
---

# geno-ws-init

`/geno-ws-init "[config|list|<freeform text>]"`
...
**Related skills:** `geno-dev`, `geno-dev-worktrees-manage`, `geno-ecosystem`, `geno-tools`
...
[:material-arrow-left: Back to geno-ws](index.md)
