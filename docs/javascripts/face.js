(function () {
  ...
  sub.textContent = "the package manager for Claude Code skillsets";
  ...
  blurb.textContent = "Install, fork, experiment, and promote Claude Code skillsets — all from one CLI.";
