(function () {
  ...
  sub.textContent = "skills catalog for AI coding agents";
  ...
  blurb.textContent = "Install, catalog, and maintain skillsets across Claude Code, Codex, Antigravity CLI, and more.";
