---
title: geno-skills-create
description: Scaffold a new skill in a geno ecosystem repo
---

# geno-skills-create

`/geno-skills-create "[skill-name|freeform description]"`
...
**Related skills:** `geno-dev-commits-rewrite`, `geno-dev-tasks-start`
