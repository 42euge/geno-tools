---
title: geno-data-workspaces-init
description: Create data workspaces for personal/life skills (taxes, remodel, career, custom)
---

# geno-data-workspaces-init

`/geno-data-workspaces-init "[list|<freeform text>]"`
