---
title: geno-audit
description: Audit a geno-ecosystem repo for compliance with skillset conventions
---
...
**Related skills:** `geno-audit-compliance`, `geno-dev-tasks-start`, `geno-foo`, `geno-install`, `geno-media-audiobook-create`
