---
title: geno-dev-loops-turbocharge
...
Run `geno-notes context --skill geno-dev-loops-turbocharge [--task <id>]` and review the returned bundle (active tasks, recent journal, relevant wiki, skill health). Use these to inform your approach — prior failures, relevant patterns, and active tasks provide context the user may not have stated explicitly.
