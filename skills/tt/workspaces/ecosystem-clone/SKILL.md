---
name: geno-tools-tt-workspaces-ecosystem-clone
description: >-
  Clone a whole GitHub/GitLab org or group of repos into one workspace.
allowed-tools: "Bash(geno-tools tt *) Bash(git *) Bash(gh *) Read(*)"
metadata:
  author: 42euge
  version: "0.1.0"
---
...
```
geno-tools tt ecosystem-clone <owner> <domain> [--track side] [-H <host>]
```
