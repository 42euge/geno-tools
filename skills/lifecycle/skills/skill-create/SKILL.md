...
If no geno repo is detected, use `AskUserQuestion` to ask which repo to target. Accept a path, a skillset name (resolved via `skills/manager/skills/install/resources/ls.sh`), or a GitHub URL.
