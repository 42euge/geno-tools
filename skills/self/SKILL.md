---
name: geno-self
description: geno-tools self-management — update the ecosystem, run the self-improvement cycle, open the docs site.
---
...
To branch into a fresh Claude Code session, see the geno-iso skillset's
`/geno-iso-sessions-spawn` (moved out of geno-tools as of 2026-05).
