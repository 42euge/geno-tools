...
4. Bump the version everywhere listed under **Versioning** below, if the change is user-facing

### Command prefix aliasing

Slash commands in all committed files (SKILL.md, AGENTS.md, README.md, docs/) must
